...
public class Variables {
	static final public String VERSION = "version 1.30";
	...
	static final public String[] ELEVATOR_SCREEN_POP_UP_1 = {"Hit the doors","with the hammer", "until they open!"};
	static final public String[] PRE_RESCUE_CAT_POP_UP_1 = {"Drive the truck"," to the tree with","the stuck cat!"};
	static final public String[] RESCUE_CAT_POP_UP_1 = {"Lift the basket","high enough so the","cat can climb down!"};
	static final public String[] PRE_RESCUE_METRO_POP_UP_1 = {"Drive the truck","to the metro station","to help people!"};
	static final public String[] RESCUE_METRO_POP_UP_1 = {"Hit the jammed","door with the","hammer to open!"};
	static final public String[] BIG_ROAD_RESCUE_POP_UP_1 = {"Drive through the","city and put off the", "fires from buldings!"};
